...
namespace {
  void ValueChangedHandler(void* userData) {
    auto* screen = static_cast<AlarmClock*>(userData);
...
AlarmClock::AlarmClock(Controllers::AlarmClockController& alarmClockController,
             Controllers::Settings::ClockType clockType,
             System::SystemTask& systemTask,
             Controllers::MotorController& motorController)
  : alarmClockController {alarmClockController}, systemTask {systemTask}, motorController {motorController} {
  ...
  hourCounter.SetValue(alarmClockController.Hours());
  ...
  minuteCounter.SetValue(alarmClockController.Minutes());
...
void AlarmClock::OnValueChanged() {
  DisableAlarm();
  UpdateAlarmTime();
}
...
void AlarmClock::UpdateAlarmTime() {
  ...
  alarmClockController.SetAlarmTime(hourCounter.GetValue(), minuteCounter.GetValue());
}
