...
namespace Pinetime {
  ...
  namespace Controllers {
    ...
    class AlarmService {
    public:
      AlarmService(Pinetime::System::SystemTask& systemTask, Pinetime::Controllers::NotificationManager& notificationManager);
      void Init();
    ...
    private:
      ...
      static constexpr uint16_t ansId {0x2922};
      static constexpr uint16_t ansCharId {0x2a47};
