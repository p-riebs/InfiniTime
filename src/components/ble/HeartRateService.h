...
namespace Pinetime {
  namespace Controllers {
    ...
    public:
      ...
      void Init();
      int OnHeartRateStatus(ble_gatt_access_ctxt* context);
    ...
    private:
      ...
      static constexpr uint16_t heartRateStatusId {0x3A37};
      ...
      static constexpr ble_uuid16_t heartRateStatusUuid {.u {.type = BLE_UUID_TYPE_16}, .value = heartRateStatusId};
